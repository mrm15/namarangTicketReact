...
const ToggleSwitch: React.FC<ToggleProps> = ({
    ...
    return (
        ...
        >
            ...
            />
            <span
                className={`absolute inset-0 flex items-center justify-center text-xs font-medium text-white transition-opacity duration-300 ${isChecked ? 'opacity-100' : 'opacity-0'}`}
            >
                {checkedText}
            </span>
            <span
