export const pivotArray = [
    ...
    {
        caption: "لبه پلاستیک چک کن ببین درسته؟ در حال کار",
        filterTextForPivot: [
            "لبه پلاستیک"
        ],
        myKey: "myItemName",
    ...
    {
        caption: "لبه خالی چیا میخواد در حال کار",
        filterTextForPivot: [
            "لبه پلاستیک"
        ],
        myKey: "myItemName",
    ...
    {
        caption: "پایه مفتول برای حروف فلز و استیل در حال کار",
        filterTextForPivot: [
            "مفتول"
        ],
        myKey: "myItemName",
