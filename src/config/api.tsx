...
export const getContactData = '/hesabfa/getContactData/'
export const deleteBill = '/hesabfa/deleteBill/'
export const deleteBillFromHesabfa = '/hesabfa/deleteBillFromHesabfa/'
export const getBillList = '/hesabfa/getBillList/'
